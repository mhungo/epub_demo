...
import epub_core.model.sqlite.DbAdapter;
import epub_core.network.QualifiedTypeConverterFactory;
import epub_core.network.R2StreamerApi;
import epub_core.ui.activity.FolioActivity;
import epub_core.ui.base.OnSaveHighlight;
import epub_core.ui.base.SaveReceivedHighlightTask;
...
public class FolioReader {
    ...
    public static final String EXTRA_BOOK_ID = "epub_core.extra.BOOK_ID";
    public static final String EXTRA_READ_LOCATOR = "epub_core.extra.READ_LOCATOR";
    public static final String EXTRA_PORT_NUMBER = "epub_core.extra.PORT_NUMBER";
    public static final String ACTION_SAVE_READ_LOCATOR = "epub_core.action.SAVE_READ_LOCATOR";
    public static final String ACTION_CLOSE_FOLIOREADER = "epub_core.action.CLOSE_FOLIOREADER";
    public static final String ACTION_FOLIOREADER_CLOSED = "epub_core.action.FOLIOREADER_CLOSED";
