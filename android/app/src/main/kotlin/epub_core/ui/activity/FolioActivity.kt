...
import epub_core.model.event.MediaOverlayPlayPauseEvent
import epub_core.model.locators.ReadLocator
import epub_core.model.locators.SearchLocator
import epub_core.model.sqlite.BookmarkTable
import epub_core.ui.adapter.FolioPageFragmentAdapter
import epub_core.ui.adapter.SearchAdapter
import epub_core.ui.fragment.FolioPageFragment
import epub_core.ui.fragment.MediaControllerFragment
import epub_core.ui.view.ConfigBottomSheetDialogFragment
import epub_core.ui.view.DirectionalViewpager
import epub_core.ui.view.FolioAppBarLayout
import epub_core.ui.view.MediaControllerCallback
import epub_core.util.AppUtil
import epub_core.util.FileUtil
import epub_core.util.UiUtil
import epub_core.viewmodels.PageTrackerViewModel
import epub_core.viewmodels.PageTrackerViewModelFactory
...
class FolioActivity : AppCompatActivity(), FolioActivityCallback, MediaControllerCallback,
    ...
    companion object {
        ...
        const val INTENT_EPUB_SOURCE_PATH = "epub_core.epub_asset_path"
        const val INTENT_EPUB_SOURCE_TYPE = "epub_source_type"
        const val EXTRA_READ_LOCATOR = "epub_core.extra.READ_LOCATOR"
...
//            }
    ...
    class DepthPageTransformer : DirectionalViewpager.PageTransformer {
    ...
    private fun configFolio() {
        ...
        mFolioPageViewPager!!.setPageTransformer(true, DepthPageTransformer())
