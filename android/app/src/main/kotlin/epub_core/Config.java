...
public class Config implements Parcelable {
    ...
    public static final String EXTRA_OVERRIDE_CONFIG = "epub_core.extra.OVERRIDE_CONFIG";
    ...
    private static final int DEFAULT_THEME_COLOR_INT = R.color.default_theme_accent_color;
